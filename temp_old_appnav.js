...
const AppNavigator = () => (
  <NavigationContainer>
    ...
    <Drawer.Screen name="Configuracion" component={ConfigStack} options={{ drawerLabel: 'Configuraci├│n', drawerIcon: ({ color, size }) => (<FontAwesome5 name="cog" size={size} color={color} />) }} />
    </Drawer.Navigator>
  </NavigationContainer>
);
