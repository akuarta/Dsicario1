...
// Portal: renderiza directamente en document.body para escapar overflow:hidden
const WebPortal = ({ children, visible }) => {
  const elRef = useRef(null);
  if (!elRef.current && typeof document !== 'undefined') {
    const div = document.createElement('div');
    div.style.cssText = 'position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:99999;';
    elRef.current = div;
  }
  ...
  if (!visible || !elRef.current || typeof ReactDOM.createPortal !== 'function') return null;
...
const CheckoutScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={{ height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column', position: 'relative' }}>
              ...
              <View style={styles.riderTrustContainer}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => {
                    ...
                    console.log('[CHECKOUT] Botón presionado, abriendo modal de repartidores...');
      ...
      {/* Modal repartidores - portal directo a document.body */}
      <WebPortal visible={riderModalVisible}>
        <View
          style={{
            flex: 1,
        ...
        >
          ...
          />
          <View style={[styles.modalContent, { maxHeight: '80%', borderTopLeftRadius: 25, borderTopRightRadius: 25 }]}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                Repartidores {isRefreshingRiders && <ActivityIndicator size="small" color={colors.primary} />}
              </Text>
            ...
            <ScrollView>
              ...
              {isRefreshingRiders && (
                <View style={{ padding: 20, alignItems: 'center' }}>
                  <ActivityIndicator size="large" color={colors.primary} />
                  <Text style={{ color: colors.text.secondary, marginTop: 10 }}>Buscando repartidores...</Text>
                </View>
              )}
              {riders.map(r => {
      ...
      {/* Overlay de negociación - portal directo a document.body */}
      <WebPortal visible={isWaitingRider}>
        <View style={{
          flex: 1,
          ...
          <GlassPanel intensity={40} style={styles.negotiationCard}>
            ...
            <TouchableOpacity style={styles.cancelBtn} onPress={handleCancelWaitingRider}>
