...
const RegisterScreen = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert(
        '¡Bienvenido! 🎉',
        `Gracias por registrarte, ${displayName}!`,
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.subtitle}>Regístrate para ordenar rápidamente</Text>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.inputWrapper}>
              <FontAwesome5 name="user" size={18} color={colors.text.secondary} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
